...
const LoadingCardRecent: FC<Props> = ({ viewRef }) => {
  return (
    <div
      ref={viewRef}
      className="mb-6 grid min-h-[280px] animate-pulse rounded-xl border border-neutral-300 bg-white shadow-md dark:border-neutral-600 dark:bg-neutral-900"
    >
...
export default LoadingCardRecent
