...
const LoadingCardFeatured: FC<Props> = ({ viewRef }) => {
  return (
    <div
      ref={viewRef}
      className="mb-6 grid min-h-[180px]  animate-pulse  rounded-xl border border-neutral-300 bg-white shadow-md dark:border-neutral-600 dark:bg-neutral-900"
    >
      <div className="mt-auto p-3">
        ...
        <div className="flex items-center justify-between py-2">
          <div className="space-y-2">
            ...
            <div className="h-3 w-[100px] rounded-md bg-neutral-200 dark:bg-neutral-800"></div>
          </div>
          <div className="space-y-2">
