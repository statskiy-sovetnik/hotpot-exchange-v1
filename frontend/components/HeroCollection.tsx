    ...
    <>
      <div className="col-span-full flex h-[100px] w-full flex-col items-center justify-center border-b border-[#D4D4D4] px-6  dark:border-[#525252] md:px-14">
        <div className="flex w-full flex-row justify-between">
          <div className="justify-left flex flex-col items-center gap-2 md:flex-row md:gap-4">
            <img
              ...
              src={header.image}
            />
            <div className="flex max-w-[120px] flex-col justify-center gap-2 md:max-w-none">
              <h1 className="reservoir-h4 truncate text-left text-sm text-black dark:text-white md:text-xl">
                {header.name}
              </h1>
              <HeroSocialLinks
