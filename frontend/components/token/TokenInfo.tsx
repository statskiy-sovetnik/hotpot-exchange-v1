...
const TokenInfo: FC<Props> = ({ token, hotpotListing }) => {
  ...
  const isHotpot =
    token?.owner?.toLowerCase() == hotpotListing?.offerer?.toLowerCase()
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        {/* <div className="flex items-center gap-2">
          ...
          '0x4650fe604e42a403494bf3190611d29419c91602' ? (
            ...
            >
              <img src="/hotpot.png" alt="Hotpot Icon" className="w-6 h-6" />
            </a>
          ) : (
            <>
              {isHotpot ? (
