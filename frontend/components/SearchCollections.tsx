        ...
        >
          {!isMobile &&
            ...
            (loading ? (
              ...
              <FiSearch
                className={`absolute top-1/2 left-3 z-10 h-4 w-4 -translate-y-1/2 text-white dark:text-neutral-300 ${
                  focused ? 'text-[#9CA3AF]' : ''
                }`}
              />
            ))}
          ...
          <input
            ...
            className={
              isMobile
                ...
                : `reservoir-label-l input-primary-outline w-full border border-white bg-[#DFE5EC] pl-9 text-sm font-medium  text-gray-500 backdrop-blur-lg  dark:border-neutral-600 dark:bg-neutral-900 dark:text-white dark:ring-primary-900 dark:placeholder:text-neutral-400  dark:focus:ring-4 lg:w-[384px]`
            }
                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          className="overflow-hidden rounded-full h-9 w-9 shrink-0"
                        />
                        <span className="ml-2 overflow-hidden reservoir-subtitle text-ellipsis dark:text-white">
                          {collection?.name}
                        </span>
                      </a>
                    </Link>
